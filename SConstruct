...
Library('foo',['src/ZPR-larger-than-life/cell.hpp','src/ZPR-larger-than-life/game.hpp' 'src/ZPR-larger-than-life/state.hpp', 'src/ZPR-larger-than-life/change.hpp'])
